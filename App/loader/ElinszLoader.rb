...
#
# =========================
# Main file for Elinsz
#
# by Elinsz - Elinsz3d.com.br
#
  ...
  module Elinsz
    ...
    class Elinsz < UI::WebDialog
        ...
        def initialize
          ...
          # Dialog parameters
          super "Elinsz", false, "Elinsz3d", 750, 600, 100, 100, true
          ...
          show do
            ...
            execute_script("var rceVersion = #{Eis_Elinsz::EXTVERSION.to_s}")
            execute_script("$('#version').text( rceVersion )")

            Sketchup.status_text = "#{Eis_Elinsz::EXTTITLE} | Welcome!"
          ...
          add_action_callback("new") do |dlg, params|
            ...
            loadcode = File.readlines(File.join( Eis_Elinsz::EXTDIR , 'Eis_Elinsz' , 'templates' , 'default.rb' ))
            ...
            mru = []
            (1..5).each { |i|
               mru.push Sketchup.read_default("Eis_Elinsz", "mru#{i}", "" )
            }
          ...
          add_action_callback("load") do |dlg, params|
            ...
            case params
              ...
              when 'default'  # Parameter "default" opens default file
                file = File.join( Eis_Elinsz::EXTDIR , 'Eis_Elinsz' , 'templates' , 'default.rb' )
            ...
            begin
              ...
              if not mru.include?(file)
                (5).downto(2) { |i|
                  Sketchup.write_default("Eis_Elinsz", "mru#{i}", mru[i-2].to_s )
                }
                Sketchup.write_default("Eis_Elinsz", "mru1", file )
              end
              # ... Write new MRU to editor menu
              dlg.execute_script("updateMRU( '#{mru[0]}' , '#{mru[1]}' , '#{mru[2]}' , '#{mru[3]}' , '#{mru[4]}' )")
              # ... Make a note of the last file (not necessarily mru1)
              Sketchup.write_default "Eis_Elinsz", "last_file", file
          ...
          add_action_callback("exec") do |dlg, params|
            ...
            Sketchup.status_text = "#{Eis_Elinsz::EXTTITLE} | Running the code..."
            ...
            begin
              ...
              Sketchup.status_text = "#{Eis_Elinsz::EXTTITLE} | Done running code"
          ...
          add_action_callback("undo") do |dlg, params|
            ...
            Sketchup.status_text = "#{Eis_Elinsz::EXTTITLE} | Last step undone"
          ...
          add_action_callback("help") do |dlg, params|
            ...
            Eis_Elinsz::browser( "#{Eis_Elinsz::EXTTITLE} - Help" , "https://Elinsz3d.com.br" )
          ...
          add_action_callback("browser") do |dlg, params|
            ...
            Eis_Elinsz::browser( "#{Eis_Elinsz::EXTTITLE} - Reference Browser" , File.join( Eis_Elinsz::EXTDIR , 'Eis_Elinsz' , 'ui-browser.html' ) , true )
    ...
    unless file_loaded?(__FILE__)
      ...
      # Add main menu items
      sub = UI.menu("Window").add_submenu( "Elinsz" )
      sub.add_item("Elinsz") { editordlg = Eis_Elinsz::Elinsz.new }
      sub.add_item("Reference Browser") { self.browser( "#{Eis_Elinsz::EXTTITLE} - Reference Browser" , File.join( Eis_Elinsz::EXTDIR , 'Eis_Elinsz' , 'ui-browser.html' ) , true ) }
      sub.add_item("Help") { self.browser( "#{Eis_Elinsz::EXTTITLE} - Help" , "https://Elinsz3d.com.br" ) }

      # Add toolbar
      as_rce_tb = UI::Toolbar.new "Elinsz"
      as_rce_cmd = UI::Command.new("Elinsz") { editordlg = Eis_Elinsz::Elinsz.new }
      # One instance only version:
      # as_rce_cmd = UI::Command.new("Elinsz") { editordlg = Eis_Elinsz::Elinsz.new unless editordlg }
      if Sketchup.version.to_i >= 16
        if RUBY_PLATFORM =~ /darwin/
          as_rce_cmd.small_icon = "img/tb_Elinsz.pdf"
          as_rce_cmd.large_icon = "img/tb_Elinsz.pdf"
        else
          as_rce_cmd.small_icon = "img/tb_Elinsz.svg"
          as_rce_cmd.large_icon = "img/tb_Elinsz.svg"
        end
      else
        as_rce_cmd.small_icon = "img/tb_Elinsz_16.png"
        as_rce_cmd.large_icon = "img/tb_Elinsz_24.png"
      end
      as_rce_cmd.tooltip = "Elinsz"
      as_rce_cmd.status_bar_text = "Projeto paramétrico para sistemas Modulares"
      as_rce_cmd.menu_text = "Elinsz"

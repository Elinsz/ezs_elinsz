  ...
  class Window < Base
    ...
    def self.add_callback( webdialog, callback_name, method_id )
      ...
      webdialog.add_action_callback( callback_name ) { |wd, callback|
        ...
        params = wd.get_element_value('EIS_JS_BRIDGE')
    ...
    def callback_handler( webdialog, callback, arguments )
      ...
      case callback
      when 'EIS::Console.log'
        Debug.puts( *arguments )
      when 'EIS::Control.on_event'
        #Debug.puts( '  > EIS::Control.on_event' )
        #Debug.puts(arguments)
        ui_id, event, *event_arguments = arguments
        event_control_callback( ui_id, event.intern, *event_arguments )
      when 'EIS::Window.on_open_url'
        event_open_url( arguments[0] )
      when 'EIS::Window.on_ready'
        event_window_ready( webdialog )
      when 'EIS::Window.on_scripts_loaded'
        event_scripts_loaded()
      end
    ensure
    ...
    def event_scripts_loaded
      Debug.puts( "EIS::Window.event_scripts_loaded()" )
    ...
    def init_webdialog( options )
      ...
      #     prevents this.
      add_callback( webdialog, 'EIS_Callback', :callback_handler )

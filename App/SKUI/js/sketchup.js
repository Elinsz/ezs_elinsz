...
var user_agent_win_su2024 = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; Trident/7.0; rv:11.0) like Gecko SketchUp Pro/24.1 (PC)';
...
var match_osx_su2024 = pattern.exec(user_agent_win_su2024);
...
document.body.innerHTML =
    ...
    '<b>Win SketchUp 2024 - Version:</b> ' + match_win_su2024[1] + ' - <b>OS:</b> ' + match_win_su2024[2] + '<hr>' +
    '<b>OSX SketchUp 2024 - Version:</b> ' + match_osx_su2024[1] + ' - <b>OS:</b> ' + match_osx_su2024[2] + '<hr>'
;
  */
  ...
  return {
    ...
    control_callback : function( ui_id, event_name, event_args ) {
      var args = [
        'EIS::Control.on_event',
        ui_id,
        event_name
      ].concat( event_args );
      Sketchup.callback.apply( this, args );
      //Sketchup.callback( 'EIS::Control.on_event', ui_id, event, args );
    },
